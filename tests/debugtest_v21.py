...
try:
    ...
    print('DEBUG', ev("JSON.stringify({title:document.querySelector('#title-screen').className,game:document.querySelector('#game-screen').className,dialogue:document.querySelector('#dialogue-panel').className,scene:document.querySelector('#scene').className,gameDisp:getComputedStyle(document.querySelector('#game-screen')).display,gameOp:getComputedStyle(document.querySelector('#game-screen')).opacity,dialogueDisp:getComputedStyle(document.querySelector('#dialogue-panel')).display,dialogueOp:getComputedStyle(document.querySelector('#dialogue-panel')).opacity,text:document.querySelector('#dialogue-text').innerText,rect:document.querySelector('#dialogue-panel').getBoundingClientRect().toJSON()})"))
